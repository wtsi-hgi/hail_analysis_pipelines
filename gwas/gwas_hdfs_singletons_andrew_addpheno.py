...
if __name__ == "__main__":
    ...
    for pheno in ph1:
        ...
        elif pheno.startswith('addpheno'):
            addpheno.append(mt.phenotype[pheno])
            addpheno2.append(pheno)
    ...
    ###########################################
    with open("/home/ubuntu/data/scripts/hail-pipelines-internal/hail_analysis_pipelines/gwas/phenotype_lists/addpheno.txt", 'r') as f:
    ...
    for index, pheno_name in enumerate(working_pheno_group_names):
        ...
        #######################################
        covariates_array = GWAS_for_addpheno(mt, running_group)
        #######################################
