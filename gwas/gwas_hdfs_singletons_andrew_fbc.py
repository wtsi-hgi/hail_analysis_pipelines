...
if __name__ == "__main__":
    ...
    ###########################################
    with open("/home/ubuntu/data/scripts/hail-pipelines-internal/hail_analysis_pipelines/gwas/phenotype_lists/fbc_part2.txt", 'r') as f:
    ...
    for index, pheno_name in enumerate(working_pheno_group_names):
        ...
        #######################################
        covariates_array = GWAS_for_nmr(mt, running_group)
        #######################################
