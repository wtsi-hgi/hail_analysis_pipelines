...
if __name__ == "__main__":
    ...
    chrX_haploid_vcf_path=""
    chrX_diploid_vcf_path=""
    ############################
    CHROMOSOME = "chrX"
    print(f"Reading {CHROMOSOME} haploid VCF calls")


    mt_hap = hl.import_vcf(chrX_haploid_vcf_path, force_bgz = True, reference_genome='GRCh38')
    mt_dip= hl.import_vcf(chrX_diploid_vcf_path, force_bgz = True, reference_genome='GRCh38')
